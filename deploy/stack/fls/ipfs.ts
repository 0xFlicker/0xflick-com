...
export class IpfsStack extends Construct {
  public readonly api: apigateway.RestApi;
  constructor(scope: Construct, id: string, props: IpfsProps) {
    const { domain, infuraIpfsAuth, corsAllowedOrigins } = props;
    super(scope, id);
    ...
    const ipfsOriginBucketParam = new ssm.StringParameter(
      ...
      "ipfs-origin-bucket",
      {
        ...
        parameterName: "/edge/fls/IpfsOriginBucket",
    ...
    const ipfsOriginIpfsAuth = new ssm.StringParameter(
      ...
      "ipfs-origin-ipfs-auth",
      {
        ...
        parameterName: "/edge/fls/IpfsOriginIPFSApiAuth",
    ...
    const ipfsCorsAllowedOrigins = new ssm.StringParameter(
      ...
      "ipfs-origin-cors-allowed-origins",
      {
        ...
        parameterName: "/edge/fls/IpfsCorsAllowedOrigins",
    ...
    const ipfsOrigin = new cloudfront.experimental.EdgeFunction(this, "ipfs", {
      ...
      code: lambda.Code.fromAsset(
        path.join(__dirname, "../../.layers/fls-ipfs-origin-layer.zip")
      ),
