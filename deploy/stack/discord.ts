...
export class DiscordStack extends cdk.Stack {
  constructor(scope: cdk.App, id: string, props: DiscordProps) {
    ...
    new ssm.StringParameter(this, "DiscordMessageTopicArn", {
      description: "The Discord message topic ARN",
      parameterName: `DiscordMessage_TopicArn`,
      stringValue: deferredMessageTopic.topicArn,
    });
