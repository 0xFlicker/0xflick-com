...
export type GetSelfQuery = { __typename?: 'Query', self?: { __typename?: 'Web3User', address: string, nonce: number, token: string, roles: Array<{ __typename?: 'Role', id: string }>, allowedActions: Array<{ __typename?: 'Permission', action: Types.PermissionAction, resource: Types.PermissionResource }> } | null };
