...
export declare namespace Seller {
  export type SellerConfigStruct = {
    totalInventory: PromiseOrValue<BigNumberish>;
    maxPerAddress: PromiseOrValue<BigNumberish>;
    maxPerTx: PromiseOrValue<BigNumberish>;
    freeQuota: PromiseOrValue<BigNumberish>;
    reserveFreeQuota: PromiseOrValue<boolean>;
    lockFreeQuota: PromiseOrValue<boolean>;
    lockTotalInventory: PromiseOrValue<boolean>;
  };
