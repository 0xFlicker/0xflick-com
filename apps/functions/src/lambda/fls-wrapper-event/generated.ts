// Generated by @wagmi/cli@0.1.15 on 6/15/2023 at 9:21:37 AM
import {
  getContract,
  GetContractArgs,
  readContract,
...
/**
 * Wraps __{@link getContract}__ with `abi` set to __{@link fameLadySquadABI}__.
 *
 * [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0xf3E6DbBE461C6fa492CeA7Cb1f5C5eA660EB1B47)
 */
export function getFameLadySquad(
  config: Omit<GetContractArgs, 'abi' | 'address'> & {
 ...
 * [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0xf3E6DbBE461C6fa492CeA7Cb1f5C5eA660EB1B47)
 */
export function readFameLadySquad<
  TAbi extends readonly unknown[] = typeof fameLadySquadABI,
  TFunctionName extends string = string,
>(
  config: Omit<ReadContractConfig<TAbi, TFunctionName>, 'abi' | 'address'> & {
    chainId?: keyof typeof fameLadySquadAddress
