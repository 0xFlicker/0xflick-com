// Generated by @wagmi/cli@0.1.15 on 4/8/2023 at 10:23:46 PM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
/**
 * [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x3018671f3495419636519f37FfeA85BfBe3dce0f)
 */
...
export const wrappedNftAddress = {
  5: "0x3018671f3495419636519f37FfeA85BfBe3dce0f" as `0x${string}}`,
} as const;
...
export function useTestNftEvent<TEventName extends string>(
  ...
  return useContractEvent({
    abi: testNftABI,
    address: testNftAddress[5] as `0x${string}`,
    ...config,
